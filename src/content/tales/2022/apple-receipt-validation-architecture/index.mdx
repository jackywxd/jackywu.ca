...
excerpt: 'In this blog post I will go throught the high level overview how we do Apple receipt validation and maintain proper us'   # TODO 待你改寫
tags: ['ios', 'apple', 'receipt', 'validation', 'verification']
legacy:
  url: '/blog/2022/2022-05-10'
---
