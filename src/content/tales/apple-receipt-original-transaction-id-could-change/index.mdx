---
title: 'Apple auto-renewable receipt real world example'
date: 2022-05-11
realm: forge
lang: en
draft: true          # 舊站標了 draft 但線上仍公開，先收起來
excerpt: 'Since in server notifications Apple does not send data that allows you to relate a user to the notification received, '   # TODO 待你改寫
tags: ['ios', 'apple', 'receipt', 'original_transaction_id']
legacy:
  url: '/blog/2022/2022-05-11'
---
