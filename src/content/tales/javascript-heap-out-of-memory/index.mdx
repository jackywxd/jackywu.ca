...
realm: forge
lang: en
excerpt: 'If you are getting below "Javascript heap out of memory" error when deploying your serverless project, try to run belo'   # TODO 待你改寫
tags: ['sls', 'deploy', 'nodejs', 'javascript', 'webpack']
legacy:
  url: '/blog/2020/2020-10-03'
---
