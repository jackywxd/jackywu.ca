...
realm: forge
lang: en
excerpt: 'An SSL VPN is a type of virtual private network that uses the Secure Sockets Layer protocol -- or, more often, its suc'   # TODO 待你改寫
tags: ['VPN', 'SSL VPN']
legacy:
  url: '/blog/2020/11-04-2020'
---
