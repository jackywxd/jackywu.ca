...
realm: forge
lang: en
excerpt: 'When a typescript Class has a long list of properties and methods, it is really painful when it comes to instantiate i'   # TODO 待你改寫
tags: ['typescript', 'class', 'type', 'constructor']
legacy:
  url: '/blog/2020/2020--4-28'
---
